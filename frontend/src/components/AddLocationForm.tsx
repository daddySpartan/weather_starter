...
export function AddLocationForm() {
  ...
  const useMyLocation = async () => {
    ...
    try {
      ...
      setSubmitError(err instanceof Error ? err.message : 'Could not detect your location');
    } finally {
      setLocating(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl border border-cyan-300/25 bg-cyan-300/10 px-3 py-2 text-sm font-medium text-cyan-50 transition hover:bg-cyan-300/15 disabled:cursor-not-allowed disabled:opacity-60"
      >
